...
//		}
		...
		Date startDate = constructDate(request.getParameter("fday"), request.getParameter("fmonth"), request.getParameter("fyear"));
		Date endDate = constructDate(request.getParameter("eday"), request.getParameter("emonth"), request.getParameter("eyear"));
