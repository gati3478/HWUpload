...
public class CreateHomework extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		hw = new Homework(manager.addHomework(hw, new Course(Integer.parseInt(course_id))));		
	...
	private Homework constructHomework(HttpServletRequest request){
		...
		return new Homework(name, description, Integer.parseInt(number), deadline, isActive, forbidLateDays);
	}
	
	private Timestamp constructTimestamp(String day, String month, String year, String hours, String minutes) {
		...
		return Timestamp.valueOf(year + "-" + month + "-" + day + " " + hours + ":" + minutes + ":00");
	}
